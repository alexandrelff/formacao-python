...
# Desafio - Conversão de dólar para real
print()
print("Conversão de valor:")
cotacao_dolar = 5.46  # 1 dólar = 5.46 reais - cotação 21/jan/22
...
if moeda_origem == "real" and moeda_destino == "dolar":
    ...
    print("O valor de R${0} reais é igual a ${1:.2f} dólares.".format(quantidade, valor_conversao))
elif moeda_origem == "dolar" and moeda_destino == "real":
    valor_conversao = int(quantidade) * cotacao_dolar
    print("O valor de ${0} dólares é igual a R${1:.2f} reais.".format(quantidade, valor_conversao))
else:
